...
void System::Shutdown()
{
    ...
    if(mpViewer)
    {
        ...
        if(deadlock_counter > 2000)
        {
            cout << "Viewer force-closed !" << endl;
        }
        
        // ORB_SLAM2: issues 547
        delete mpViewer;
    ...
    if(deadlock_counter > 2000)
    {
        cout << "Closer force-closed int checking finished!" << endl;
    }
    ...
    if(deadlock_counter > 2000)
    {
        cout << "Closer force-closed in running GBA!" << endl;
    }
